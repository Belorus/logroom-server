...
let HTMLResponseBuilder = (() => {
	...
	function actionPushLog(request) {
		return runAction.call(this, this.journal, this.journal.pushLog, ['session_id', 'seq_number', 'log', 'additional_parameters'], request);
	}

	function actionPushLogs(request = {}) {
		return runAction.call(this, this.journal, this.journal.pushLogs, ['session_id', 'seq_number', 'logs', 'additional_parameters'], request);
	}
